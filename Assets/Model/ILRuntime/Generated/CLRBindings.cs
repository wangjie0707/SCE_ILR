...
namespace ILRuntime.Runtime.Generated
{
    class CLRBindings
    {
        ...
        public static void Initialize(ILRuntime.Runtime.Enviorment.AppDomain app)
        {
            ...
            //UnityEngine.UI_Framework_GameEntry_Binding.Register(app);
            //UnityEngine.UI_Framework_BaseComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_EventComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_TimeComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_FsmComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_ProcedureComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_DataTableComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_SocketComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_HttpComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_DataComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_LocalizationComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_PoolComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_SceneComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_SettingComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_DataComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_EntityComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_ResourceComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_DownloadComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_UIComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_SoundComponent_Binding.Register(app);
            //UnityEngine.UI_Framework_ILRuntimeComponent_Binding.Register(app);
        }
