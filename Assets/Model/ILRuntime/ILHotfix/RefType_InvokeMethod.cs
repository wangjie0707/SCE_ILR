namespace ILHotfix
{
    public partial class RefType
    {
        ...
        {
            using (var obj = new ILHotfix.EmptyObjs())
            {
        ...
        {
            using (var obj = new ILHotfix.Objects(p0))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3, p4))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3, p4, p5))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3, p4, p5, p6))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3, p4, p5, p6, p7))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3, p4, p5, p6, p7, p8))
            {
                InvokeMethod(name, obj.objs);
            }
        }
        ...
        {
            using (var obj = new ILHotfix.Objects(p0, p1, p2, p3, p4, p5, p6, p7, p8, p9))
            {
                InvokeMethod(name, obj.objs);
            }
        }
