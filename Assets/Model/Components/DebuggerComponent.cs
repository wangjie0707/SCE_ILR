...
namespace Myth
{
    ...
    /// 调试组件
    /// </summary>
    public sealed partial class DebuggerComponent : GameBaseComponent
    {
        /// <summary>
        /// 默认调试器漂浮框大小
        /// </summary>
        ...
        public override void OnUpdate(float deltaTime, float unscaledDeltaTime)
        {
            ...
            m_FpsCounter.Update(deltaTime, unscaledDeltaTime);
        ...
        private void DrawDebuggerWindowGroup(IDebuggerWindowGroup debuggerWindowGroup)
        {
            ...
            {
                names.Add(TextUtil.Format("<b>{0}</b>", debuggerWindowNames[i]));
            }
        ...
        private void DrawDebuggerWindowIcon(int windowId)
        {
            ...
            string title = TextUtil.Format("<color=#{0}{1}{2}{3}><b>FPS: {4}</b></color>", color.r.ToString("x2"), color.g.ToString("x2"), color.b.ToString("x2"), color.a.ToString("x2"), m_FpsCounter.CurrentFps.ToString("F2"));
