...
namespace Myth
{
    ...
    public static class AssemblyUtil
    {
        ...
        #region 获取已加载的程序集 GetAssemblies
        /// <summary>
        /// 获取已加载的程序集
        /// </summary>
        ...
        #region 获取已加载的程序集中的所有类型  GetTypes
        /// <summary>
        /// 获取已加载的程序集中的所有类型
        /// </summary>
        ...
        #region 获取已加载的程序集中的指定类型 GetType
        /// <summary>
        /// 获取已加载的程序集中的指定类型
        /// </summary>
        ...
        public static Type GetType(string typeName)
        {
            ...
            foreach (System.Reflection.Assembly assembly in s_Assemblies)
            {
                type = Type.GetType(TextUtil.Format("{0}, {1}", typeName, assembly.FullName));
                if (type != null)
                {
                    s_CachedTypes.Add(typeName, type);
                    return type;
