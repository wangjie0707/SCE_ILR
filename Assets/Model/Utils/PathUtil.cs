...
namespace Myth
{
    ...
    public static class PathUtil
    {
        ...
        #region 获取连接后的路径 GetCombinePath
        /// <summary>
        /// 获取连接后的路径
        /// </summary>
        ...
        #region 获取远程格式的路径（带有file:// 或 http:// 前缀） GetRemotePath
        /// <summary>
        ...
        public static string GetResourceNameWithSuffix(string resourceName)
        {
            ...
            return TextUtil.Format("{0}.dat", resourceName);
        }
        ...
        public static string GetResourceNameWithCrc32AndSuffix(string resourceName, int hashCode)
        {
            ...
            return TextUtil.Format("{0}.{1:x8}.dat", resourceName, hashCode);
        }
