...
namespace Myth
{
    ...
    public static class RandomUtil
    {
        ...
        /// <returns>大于等于零且小于 maxValue 的 32 位带符号整数，即：返回值的范围通常包括零但不包括 maxValue不过，如果 maxValue 等于零，则返回 maxValue</returns>
        ...
        /// <returns>一个大于等于 minValue 且小于 maxValue 的 32 位带符号整数，即：返回的值范围包括 minValue 但不包括 maxValue如果 minValue 等于 maxValue，则返回 minValue</returns>
