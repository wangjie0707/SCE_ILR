...
namespace Myth
{
    ...
    /// WWW 下载代理
    /// </summary>
    public class WWWDownloadAgent : DownloadAgentBase, IDisposable
    {
        ...
        public override void OnUpdate(float deltaTime, float unscaledDeltaTime)
        {
            ...
            if (!m_WWW.isDone)
            {
                if (m_LastDownloadedSize < m_WWW.bytesDownloaded)
                {
                    ...
                    DownloadUpdate(m_WWW.bytesDownloaded, null);
                }
            ...
            {
                DownloadComplete(m_WWW.bytesDownloaded, m_WWW.bytes);
            }
        }
    }
}
