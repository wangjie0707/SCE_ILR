...
namespace Myth
{
    ...
    public class DownloadTask : ITask
    {
        ...
        public DownloadTask(string downloadPath, string downloadUri, int priority, int flushSize, float timeout, object userData, Action<bool> success = null)
        {
            m_SerialId = s_Serial++;
            m_Priority = priority;
            m_Done = false;
