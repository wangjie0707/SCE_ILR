...
namespace Myth
{
    ...
    public sealed class SoundAgent
    {
        ...
        {
            m_SoundAgentHelper.OnUpdate(deltaTime, unscaledDeltaTime);
        }
        ...
        public void Play()
        {
            m_SoundAgentHelper.Play(Constant.Sound.DefaultFadeInSeconds);
        }
        ...
        public void Stop()
        {
            m_SoundAgentHelper.Stop(Constant.Sound.DefaultFadeOutSeconds);
        }
        ...
        public void Pause()
        {
            m_SoundAgentHelper.Pause(Constant.Sound.DefaultFadeOutSeconds);
        }
        ...
        public void Resume()
        {
            m_SoundAgentHelper.Resume(Constant.Sound.DefaultFadeInSeconds);
        }
        ...
        public void Reset()
        {
            ...
            {
                GameEntry.Resource.UnloadAsset(m_SoundAsset);
                m_SoundAsset = null;
            }

            m_SetSoundAssetTime = DateTime.MinValue;
            Time = Constant.Sound.DefaultTime;
            MuteInSoundGroup = Constant.Sound.DefaultMute;
            Loop = Constant.Sound.DefaultLoop;
            Priority = Constant.Sound.DefaultPriority;
            VolumeInSoundGroup = Constant.Sound.DefaultVolume;
            Pitch = Constant.Sound.DefaultPitch;
            PanStereo = Constant.Sound.DefaultPanStereo;
            SpatialBlend = Constant.Sound.DefaultSpatialBlend;
            MaxDistance = Constant.Sound.DefaultMaxDistance;
            DopplerLevel = Constant.Sound.DefaultDopplerLevel;
            m_SoundAgentHelper.Reset();
        }

        internal bool SetSoundAsset(UnityEngine.Object soundAsset)
        {
            Reset();
