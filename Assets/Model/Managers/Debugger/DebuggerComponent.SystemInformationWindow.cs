        ...
        private sealed class SystemInformationWindow : ScrollableDebuggerWindowBase
        {
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Processor Frequency:", TextUtil.Format("{0} MHz", SystemInfo.processorFrequency.ToString()));
                    DrawItem("Memory Size:", TextUtil.Format("{0} MB", SystemInfo.systemMemorySize.ToString()));
