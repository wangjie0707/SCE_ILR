...
namespace Myth
{
    public partial class DebuggerComponent
    {
        ...
        {
            private PoolComponent m_PoolComponent = null;

            public override void Initialize(params object[] args)
            {
                m_PoolComponent = GameEntry.GetBaseComponent<PoolComponent>();
                if (m_PoolComponent == null)
                {
                    Debug.LogError("Object pool component is invalid.");
                    return;
                }
            }
            ...
            protected override void OnDrawScrollableWindow()
            {
                ...
                {
                    DrawItem("Object Pool Count", m_PoolComponent.Count.ToString());
                }
                GUILayout.EndVertical();
                ObjectPoolBase[] objectPools = m_PoolComponent.GetAllObjectPools(true);
