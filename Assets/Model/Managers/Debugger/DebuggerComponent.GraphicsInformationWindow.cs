        ...
        private sealed class GraphicsInformationWindow : ScrollableDebuggerWindowBase
        {
            protected override void OnDrawScrollableWindow()
            {
                ...
                GUILayout.BeginVertical("box");
                {
                    ...
                    DrawItem("Memory Size:", TextUtil.Format("{0} MB", SystemInfo.graphicsMemorySize.ToString()));
            ...
            {
                return TextUtil.Format("Shader Model {0}.{1}", (shaderLevel / 10).ToString(), (shaderLevel % 10).ToString());
            }
        }
    }
}
